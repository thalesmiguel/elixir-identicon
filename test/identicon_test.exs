defmodule IdenticonTest do
  ...
  describe "filter_odd_squares/1" do
    defp initial_struct_with_grid do
      %Identicon.Image{
    ...
    test "retuns a grid with only the odd elements" do
      struct = Identicon.filter_odd_squares(initial_struct_with_grid())
  ...
  describe "build_grid/1" do
    defp initial_struct_with_hex do
      %Identicon.Image{
    ...
    test "retuns a grid based on the given hex" do
      struct = Identicon.build_grid(initial_struct_with_hex())
    ...
    test "always returns the same grid based on the given struct argument" do
      first_struct = Identicon.build_grid(initial_struct_with_hex())
      second_struct = Identicon.build_grid(initial_struct_with_hex())
    ...
    test "returns different structs for different string arguments" do
      ...
      first_hash_input = Identicon.build_grid(initial_struct_with_hex())
  ...
  describe "pick_color/1" do
    ...
    test "retuns the first 3 arguments of hex as a rgb color" do
      struct = Identicon.pick_color(initial_struct_with_hex())
    ...
    test "always returns the same color based on the given struct argument" do
      first_struct = Identicon.pick_color(initial_struct_with_hex())
      second_struct = Identicon.pick_color(initial_struct_with_hex())
    ...
    test "returns different structs for different string arguments" do
      ...
      first_hash_input = Identicon.pick_color(initial_struct_with_hex())
